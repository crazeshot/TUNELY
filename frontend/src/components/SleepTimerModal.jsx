    ...
    >
      ...
      >
        ...
        {remainingMinutes !== null && (
          <div className="mt-4 p-3 rounded-2xl bg-pink-500/15 border border-pink-500/30 flex items-center justify-between">
            ...
            <button
              ...
              className="text-xs text-white/70 hover:text-red-400 font-semibold"
            >
              Turn Off
            </button>
          </div>
        ...
        <div className="space-y-2 mt-4">
          {options.map((opt) => (
            <button
              ...
              className="w-full flex items-center justify-between px-4 py-3 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 text-xs font-medium text-white/80 hover:text-white transition-all text-left"
            >
              <span>{opt.label}</span>
