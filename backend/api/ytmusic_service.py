...
High-Performance YouTube Music & Video integration service with:
 ...
 - Music-focused YouTube video scraping
 - Unauthenticated public search, charts, albums, and artists
...
class YTMusicService:
    ...
    def search_youtube_videos(self, query, limit=16):
        """
        Search YouTube videos directly with instant TTL memory caching.
        """
        if not query:
            return []
        ...
        try:
            ...
            search_query = query
            keywords = ['song', 'music', 'audio', 'remix', 'soundtrack', 'theme', 'official', 'mv', 'album']
            ...
            print(f"[YouTubeSearch] Error: {e}. Falling back to ytmusic search.")
